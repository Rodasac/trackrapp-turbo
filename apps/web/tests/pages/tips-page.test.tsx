...
describe("Tips page", () => {
  ...
  it("renders AI tip cards for Pro user with tips", () => {
    ...
    mockAiTipsData.mockReturnValue({
      data: [
        { id: 1, title: "Save on streaming", message: "Switch to annual", category: "savings", generatedAt: "2026-02-28T00:00:00Z", expiresAt: "2026-03-08T00:00:00Z" },
        { id: 2, title: "High spend alert", message: "Your software costs are rising", category: "warning", generatedAt: "2026-02-28T00:00:00Z", expiresAt: "2026-03-08T00:00:00Z" },
      ],
      isLoading: false,
    });
    render(<TipsPage />, { wrapper: createWrapper() });
