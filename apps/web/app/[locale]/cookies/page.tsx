      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert mt-10 max-w-none space-y-8 text-sm leading-7">
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-2">{t("s3Intro")}</p>
            <ul className="text-muted-foreground mt-2 ml-4 list-disc space-y-1">
              <li>{t("s3Item1")}</li>
              <li>{t("s3Item2")}</li>
            </ul>
            <p className="text-muted-foreground mt-2">{t("s3Note")}</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold">{t("s4Title")}</h2>
            <p className="text-muted-foreground mt-2">{t("s4Body")}</p>
            <p className="text-muted-foreground mt-2">{t("s4Intro2")}</p>
            <ul className="text-muted-foreground mt-2 ml-4 list-disc space-y-1">
              <li>{t("s4Chrome")}</li>
              <li>{t("s4Firefox")}</li>
              <li>{t("s4Safari")}</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-2">{t("s5Intro")}</p>
            <ul className="text-muted-foreground mt-2 ml-4 list-disc space-y-1">
              <li>{t("s5Item1")}</li>
              <li>{t("s5Item2")}</li>
              <li>{t("s5Item3")}</li>
            ...
            <p className="text-muted-foreground mt-2">{t("s5Consent")}</p>
          </section>
